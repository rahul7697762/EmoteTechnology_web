...
const navigation = [
  ...
  { name: "Leave Requests", href: "/employee/leave", icon: FileText },
  { name: "Complaints", href: "/employee/complaints", icon: MessageSquareWarning },
  { name: "ID Card", href: "/employee/id-card", icon: IdCard },
      ...
      `}>
        ...
        <div className="p-4 border-t border-neutral-800">
          <button
            ...
            className="flex w-full items-center px-3 py-2 text-sm font-medium rounded-md text-red-400 hover:bg-red-500/10 transition-colors"
          >
